...
- **🧠 Scripture Memory Tool**: Interactive scripture memorization suite with automated verse fetching via `bible-api.com` and fallback APIs (NIV, WEB, KJV, BBE, ASV, YLT) and Custom text paste, offering 5 distinct practice modes:
